...
impl Zitadel {
    ...
    pub fn with_external_secure(mut self, external_secure: bool) -> Self {
        self.env_vars
            .insert("ZITADEL_EXTERNALSECURE".to_owned(), Self::bool_to_string(external_secure));
        self
    }
    ...
    pub fn with_postgres_database(
        ...
        match host {
            Some(host) => self.env_vars.insert("ZITADEL_DATABASE_POSTGRES_HOST".to_owned(), host.to_owned()),
    ...
    pub fn with_postgres_database_user(
        ...
        match username {
            ...
            None => self.env_vars.remove("ZITADEL_DATABASE_POSTGRES_USER_USERNAME"),
        };
        match password {
            ...
            None => self.env_vars.remove("ZITADEL_DATABASE_POSTGRES_USER_PASSWORD"),
        };
        match ssl_mode {
            ...
            None => self.env_vars.remove("ZITADEL_DATABASE_POSTGRES_USER_SSL_MODE"),
        };
        self
    }
    ...
    pub fn with_postgres_database_admin(
        ...
        match username {
            ...
            None => self.env_vars.remove("ZITADEL_DATABASE_POSTGRES_ADMIN_USERNAME"),
        };
        match password {
            Some(password) => self.env_vars.insert(
            ...
            None => self.env_vars.remove("ZITADEL_DATABASE_POSTGRES_ADMIN_PASSWORD"),
        };
        match ssl_mode {
            Some(ssl_mode) => self.env_vars.insert(
            ...
            None => self.env_vars.remove("ZITADEL_DATABASE_POSTGRES_ADMIN_SSL_MODE"),
        };
        self
    }
}
